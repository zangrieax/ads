    ...
    <footer className="vogue-footer">
      <div className="footer-container">
        ...
        <div className="footer-links fade-in">
          <a href="/docs/confidentiality.pdf" className="footer-link">Конфиденциальность</a>
          <a href="/docs/agreement.pdf" className="footer-link">Партнерское соглашение</a>
          <a href="/docs/compliance-152fz.pdf" className="footer-link">152-ФЗ Комплаенс</a>
          <a href="/docs/contacts.pdf" className="footer-link">Контакты</a>
        </div>
